   ...
   <body>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                        ...
                        <img src="images/img-2.webp" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
                                 <li><a href="#">Cómpralo ahora</a></li>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                        ...
                        <img src="images/img-3.webp" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
                                 <li><a href="#">Cómpralo ahora</a></li>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                        ...
                        <img src="images/img-7.webp" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
                                 <li><a href="#">Cómpralo ahora</a></li>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                        ...
                        <img src="images/img-8.webp" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
                                 <li><a href="#">Cómpralo ahora</a></li>
               ...
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                        ...
                        <img src="images/img-9.jpg" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
                                 <li><a href="#">Cómpralo ahora</a></li>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                        ...
                        <img src="images/img-10.webp" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
                                 <li><a href="#">Cómpralo ahora</a></li>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                        ...
                        <img src="images/img-11.webp" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
                                 <li><a href="#">Cómpralo ahora</a></li>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                        ...
                        <img src="images/img-12.jpg" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
                                 <li><a href="#">Cómpralo ahora</a></li>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="about_taital_main">
                        ...
                        <p class="about_text">Nosotros somos una tienda de maquillaje para las apasionadas a este mundo donde podrás encontrar marcas exclusivas también para el cuidado facial, sets de brochas, paletas de sobras de las mejores marcas y mucho más.</p>
                        <div class="readmore_bt"><a href="#">Más información</a></div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     ...
                     <div class="client_section_2">
                        <div class="client_main">
                           ...
                           <div class="client_right">
                              <h3 class="name_text">Alejandra Martinez</h3>
                              <p class="dolor_text">Estoy encantada con el servicio de esta página, tiene todo lo que busco.</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="carousel-item">
                     <div class="client_section_2">
                        <div class="client_main">
                           ...
                           <div class="client_right">
                              <h3 class="name_text">Mariana Barrios</h3>
                              <p class="dolor_text">Me encanta porque tiene productos económicos y de muy buena calidad, la recomiendo mucho.</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="carousel-item">
                     <div class="client_section_2">
                        <div class="client_main">
                           ...
                           <div class="client_right">
                              <h3 class="name_text">Daniela Arauz</h3>
                              <p class="dolor_text">Compre una base MAC y un set de brochas, todo de muy buena calidad y la base de alta cobertura. Me encanto todo lo que compre.</p>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <h1 class="contact_taital">Nuestro contacto</h1>
                  <p class="contact_text">Cualquier consulta, duda o reclamo nos pueden escribir a nuestro correo, mandarnos un mensaje al whatsApp o visitar nuestro local. </p>
               </div>
               <div class="col-md-6">
                  <div class="contact_main">
                     <div class="contact_bt"><a href="#">Contáctanos</a></div>
                     <div class="newletter_bt"><a href="#">Correo</a></div>
                  </div>
               </div>
            </div>
         </div>
